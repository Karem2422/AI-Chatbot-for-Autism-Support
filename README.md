...
*   **Daily Routine Management**: An interactive checklist allows users to view and mark off daily tasks, promoting structure and predictability.
*   **Calming UI/UX**: Designed with a soothing color palette (Royal Purple & Teal), soft gradients, and smooth animations to reduce sensory overload.
*   **Mobile-First Design**: Optimized for mobile devices with a layout that resembles modern messaging apps.
*   **Quick Actions**: One-tap buttons for common needs like "I feel Anxious" or "Show my Schedule".
...
1.  **Clone the repository**
    ```bash
    git clone https://github.com/yourusername/ai-chatbot-support.git
